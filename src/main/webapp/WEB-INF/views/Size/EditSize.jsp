...
<div class="wrapper">
    ...
    <div class="dashboard container-fluid ps-0 pe-0">
        ...
        <div class="content-admin">
            ...
            <form class="container form-edit" action="/size/update?id=${detail.id}" method="post">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="ma_size" value="${detail.ma_size}" >
                    <label>Mã size</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="ten_size" value="${detail.ten_size}">
