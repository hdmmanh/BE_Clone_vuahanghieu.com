...
<div class="wrapper">
    ...
    <div class="dashboard container-fluid ps-0 pe-0">
        ...
        <div class="content-admin">
            <h3 style="color:aliceblue " class="ms-3 mt-3 mb-3">Size</h3>
                    ...
                    <c:forEach items="${listSize}" var="sz" varStatus="i">
                        <tr style="vertical-align: middle;text-align: center">
                            ...
                            <td class="button-action">
                                <a href="/size/edit?id=${sz.id}" class="btn btn-info">Chi tiết</a>
                                <a href="/size/delete?id=${sz.id}" onclick="return confirmDelete()" class="btn btn-primary">Xóa</a>
                        ...
                        <div>
                            <c:choose>
                                <c:when test="${currentPage > 1}">
                                    <a href="/pageSize/${currentPage - 1}" class="button-prev">Previous</a>
                                </c:when>
                                <c:otherwise>
                            ...
                            <c:forEach var="i" begin="1" end="${totalPages}">
                                <c:choose>
                                    <c:when test="${currentPage != i}">
                                        <a href="/pageSize/${i}" class="button-page"
                                        >${i}</a>
                                    </c:when>
                                    <c:otherwise>
                        ...
                        <div>
                            <c:choose>
                                <c:when test="${currentPage < totalPages}">
                                    <a href="/pageSize/${currentPage + 1}" class="button-next">Next</a>
                                </c:when>
                                <c:otherwise>
