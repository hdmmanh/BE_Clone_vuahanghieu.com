...
<div class="wrapper">
    ...
    <div class="dashboard container-fluid ps-0 pe-0">
        ...
        <div class="content-admin">
            ...
            <form class="container form-edit" action="/san-pham/update?id=${detail.id}" method="post">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="ma_san_pham" value="${detail.ma_san_pham}" readonly>
                    <label>Mã sản phẩm</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="ten_san_pham" value="${detail.ten_san_pham}">
                ...
                <select class="form-select mt-3" aria-label="Default select example" name="danhMuc.id">
                    <c:forEach items="${listDanhMuc}" var="dm">
                        <option value="${dm.id}" ${detail.danhMuc.ten_danh_muc.equals(dm.ten_danh_muc) ? 'selected' : ''}>${dm.ten_danh_muc}</option>
                    </c:forEach>
                </select>
