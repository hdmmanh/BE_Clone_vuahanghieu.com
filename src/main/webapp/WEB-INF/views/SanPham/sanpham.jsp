...
<div class="wrapper">
    ...
    <div class="dashboard container-fluid ps-0 pe-0">
        ...
        <div class="content-admin">
            <h3 style="color:aliceblue " class="ms-3 mt-3 mb-3">Sản phẩm</h3>
                    ...
                    <c:forEach items="${listSanPham}" var="sp" varStatus="i">
                        <tr style="vertical-align: middle">
                            ...
                            <td class="button-action">
                                <a href="/san-pham/edit?id=${sp.id}" class="btn btn-info">Chi tiết</a>
                                <a href="/san-pham/delete/${sp.id}" onclick="return confirmDelete()" class="btn btn-primary">Xóa</a>
                        ...
                        <div>
                            <c:choose>
                                <c:when test="${currentPage > 1}">
                                    <a href="/page/${currentPage - 1}" class="button-prev">Previous</a>
                                </c:when>
                                <c:otherwise>
                        ...
                        <div>
                            <c:choose>
                                <c:when test="${currentPage < totalPages}">
                                    <a href="/page/${currentPage + 1}" class="button-next">Next</a>
                                </c:when>
                                <c:otherwise>
