...
<div class="wrapper">
    ...
    <div class="dashboard container-fluid ps-0 pe-0">
        ...
        <div class="content-admin">
            <h3 style="color:aliceblue " class="ms-3 mt-3 mb-3">Danh mục</h3>
                    ...
                    <c:forEach items="${listDanhMuc}" var="dm" varStatus="i">
                        <tr style="vertical-align: middle">
                            ...
                            <td class="button-action">
                                <a href="/danh-muc/edit?id=${dm.id}" class="btn btn-info">Chi tiết</a>
                                <a href="/danh-muc/delete?id=${dm.id}" onclick="return confirmDelete()" class="btn btn-primary">Xóa</a>
                        ...
                        <div>
                            <c:choose>
                                <c:when test="${currentPage > 1}">
                                    <a href="/pageDanhMuc/${currentPage - 1}" class="button-prev">Previous</a>
                                </c:when>
                                <c:otherwise>
                            ...
                            <c:forEach var="i" begin="1" end="${totalPages}">
                                <c:choose>
                                    <c:when test="${currentPage != i}">
                                        <a href="/pageDanhMuc/${i}" class="button-page"
                                        >${i}</a>
                                    </c:when>
                                    <c:otherwise>
                        ...
                        <div>
                            <c:choose>
                                <c:when test="${currentPage < totalPages}">
                                    <a href="/pageDanhMuc/${currentPage + 1}" class="button-next">Next</a>
                                </c:when>
                                <c:otherwise>
